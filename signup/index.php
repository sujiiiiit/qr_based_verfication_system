    ...
    <div class="tabs-container" data-animation='tabs'>
      <div class="tabs-tab tab1 active">
        ...
        <div class="toast"></div>
          ...
          <p class="subtitle">Please enter your Name, valid Email id and a password.</p>
            ...
            <form id="form" class="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
              ...
              <div class='input-field'>
                <label for="fullname" class="label">
                  <input id='fullname' type="text" placeholder=" " name="fullname" autocomplete="off" />
                  <span class="placeholder">Full Name (required)</span>
                </label>

                <label for="email" class="label">
                  <input data-invalid="Invalidemail" id='email' type="email" placeholder=" " name="email" autocomplete="off" />
              ...
              <button data-ripple='rgb(0,0,0,.4)' class="btn signbtn" type='submit'>Signup
                <svg class="spinner " viewBox="0 0 50 50">
                  <circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="2"></circle>
                </svg>
              </button>
              <br>
              <a class="link center" href="../login/">Already have a account? Login</a>
      ...
      <div class="tabs-tab tab2">
        <div class="container">
          ...
          <div class="wrongemaildiv"> <span class="wrongemail"></span><a id="editemail"><svg title="wrong email ?" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        $.ajax({
          ...
          success: function(response) {
            if (response === 'email-error') {
              ...
              $(".emailplaceholder").text("Email Already Exist");
              $('#email').focus();
              $(".spinner").removeClass("visible");
